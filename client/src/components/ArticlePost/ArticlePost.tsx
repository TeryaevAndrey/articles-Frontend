  ...
  return (
    <Wrapper onClick={onClick} className={className}>
      ...
      <Footer>
        ...
        <Icon onClick={deleteHandler} width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18.2643 12.6637C16.1935 12.6637 14.5088 14.3484 14.5088 16.4192C14.5088 18.49 16.1935 20.1747 18.2643 20.1747C20.335 20.1747 22.0197 18.49 22.0197 16.4192C22.0197 14.3484 20.3351 12.6637 18.2643 12.6637ZM20.1068 17.4588C20.3284 17.6805 20.3284 18.0399 20.1068 18.2617C19.9959 18.3725 19.8505 18.428 19.7053 18.428C19.5601 18.428 19.4148 18.3725 19.3039 18.2617L18.2643 17.2221L17.2248 18.2617C17.1139 18.3725 16.9686 18.428 16.8234 18.428C16.6781 18.428 16.5328 18.3725 16.4219 18.2617C16.2003 18.04 16.2003 17.6806 16.4219 17.4588L17.4615 16.4192L16.4218 15.3796C16.2001 15.1579 16.2001 14.7985 16.4218 14.5767C16.6435 14.3551 17.0029 14.3551 17.2247 14.5767L18.2643 15.6163L19.3038 14.5767C19.5255 14.3551 19.885 14.3551 20.1068 14.5767C20.3284 14.7984 20.3284 15.1578 20.1068 15.3796L19.0672 16.4192L20.1068 17.4588Z" fill="#4D3D3D"/>
        <path d="M19.1376 5.03636C19.1375 4.12542 18.3964 3.38434 17.4854 3.38434H4.63249C3.72155 3.38434 2.98047 4.12542 2.98047 5.03636V6.57205H19.1377V5.03636H19.1376Z" fill="#4D3D3D"/>
        <path d="M18.2643 11.5284C18.3681 11.5284 18.4709 11.5327 18.573 11.5391L18.8017 7.7074H14.8145V12.9558C15.6996 12.0742 16.9192 11.5284 18.2643 11.5284Z" fill="#4D3D3D"/>
        <path d="M8.74481 1.13535H13.3736V2.24891H14.509V0.567677C14.509 0.254125 14.2548 0 13.9413 0H8.17705C7.8635 0 7.60938 0.254125 7.60938 0.567677V2.24891H8.74473V1.13535H8.74481Z" fill="#4D3D3D"/>
        <path d="M14.8144 23.0428C14.8144 23.4967 14.4464 23.8646 13.9925 23.8646C13.5385 23.8646 13.1706 23.4967 13.1706 23.0428V7.7074H8.9473V23.0428C8.9473 23.4967 8.57928 23.8646 8.12541 23.8646C7.67146 23.8646 7.30353 23.4967 7.30353 23.0428V7.7074H3.31641L4.31649 24.4662C4.33442 24.766 4.58274 25 4.88307 25H17.2348C17.5353 25 17.7836 24.766 17.8015 24.4662L17.9903 21.3019C16.7541 21.2333 15.639 20.7039 14.8144 19.8826V23.0428Z" fill="#4D3D3D"/>
            </Icon>
          </IconWrapper>
        )}
      </Footer>
